 ...
 */
if (isset($_POST['equipment_submit']) && !empty($_POST['equipment_submit'])) {
        ...
        */ 
		...
		header("location: equipment_entry.php");
		exit();
}
...
if(isset($_POST['equipment_update_submit']) && !empty($_POST['equipment_update_submit'])){
    $receive_total      =   0;
    $no_of_material     =   0;
